...
export class ClasseService {
  ...
  public resourceUrlDTO = SERVER_API_URL + 'api/classes-dto';
  public resourceUrlBulletin = SERVER_API_URL + 'api/classes-bulletin';
  ...
  createBulletins(classe: IClasse): Observable<EntityResponseType> {
    return this.http.put<IClasse>(this.resourceUrlBulletin, classe, { observe: 'response' });
  }
  ...
  findComplet(id: number): Observable<EntityResponseType> {
    return this.http.get<IClasse>(`${this.resourceUrlDTO}/${id}`, { observe: 'response' });
  }
